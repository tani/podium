...
This is a parser and tools for L<Plain Old Documentation (POD)|https://perldoc.perl.org/perlpod>.
...
=item * Multiple output formats (HTML, Markdown, LaTeX)
...
=head3 Application Programming Interface
  ...
  podium.process(inputString, outputFormat) -- returns outputString
